...
df_full = pd.read_csv('data/analytical_data.csv')
create_plot(df_full, 'figures/analytical_stability_plot.png', 'Standard Model Vacuum Stability (Analytical, Full View)', s=5)

# Close-up plot (using dense analytical closeup data)
print("Plotting close-up view using dense analytical closeup data...")
df_dense = pd.read_csv('data/analytical_dense_closeup.csv')
create_plot(df_dense, 'figures/analytical_stability_closeup.png', 'Standard Model Vacuum Stability (Analytical, Close-up)', xlim=(110, 140), ylim=(160, 185), s=2)
